...
Definition AllPPOGraphs := GraphsToVerifyTSOPPO (gem5fixed_O3_Pipeline 1).

Definition AllLitmusTestGraphs :=
    map (fun t => t (gem5fixed_O3_Pipeline 4)) AllLitmusTests.
...
*)
Extraction "gem5fixedgraphs.ml" AllGraphs.
