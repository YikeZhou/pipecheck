...
Definition AllPPOGraphs := GraphsToVerifyTSOPPO (OpenSPARC_T2_Pipeline 1).

Definition AllLitmusTestGraphs :=
    map (fun t => t (OpenSPARC_T2_Pipeline 4)) AllLitmusTests.
...
*)
Extraction "opensparcgraphs.ml" AllGraphs.
